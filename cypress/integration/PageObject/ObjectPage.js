class SigninPage {
    ...
    ErrorIcon() {
        return cy.get('.MuiAlert-icon > .MuiSvgIcon-root > path')
    }
    checkSuccess(usn) {
    ...
    allFields() {
        return cy.get('fieldset.PrivateNotchedOutline-root-7.MuiOutlinedInput-notchedOutline')
    }
    usernameFieldErrorColor() {
        return cy.get('#username-label')
    }
    passwordFieldErrorColor() {
    ...
    ErrorMessageAndColorUsername () {
        return cy.get('#username-helper-text')
    }
    ErrorMessageAndColorPassword () {
