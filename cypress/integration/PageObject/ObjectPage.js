class SigninPage {
    ...
    usernameFieldErrorColorCheck() {
        cy.get('#username-label')
        .should('contain', 'Username')
        .should('have.css', 'color','rgb(244, 67, 54)')
        return this
    }
    passwordFieldErrorColorCheck() {
        cy.get('#password-label')
        .should('contain', 'Password')
        .should('have.css', 'color','rgb(244, 67, 54)')
        return this
    }
    enterShortPassword(psw) {
        cy.get('#password')
        .should('be.visible')
        .type('220')
        return this
    ...
    checkErrorMessageAndColor (username) {
        cy.get('#username-helper-text')
        .should('contain', 'Username is required')
        .should('have.css', 'color', 'rgb(244, 67, 54)')
    }
    checkErrorMessageAndColor (password) {
